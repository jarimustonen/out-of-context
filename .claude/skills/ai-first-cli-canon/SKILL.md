...
description: "The AI-first CLI canon (AGENTS-AI-FIRST-CLI.md, §1–§22): the family's binding conventions for any CLI surface — strict input validation, --json output, JSONL logs, non-interactive operation, informative errors, meaningful exit codes, composable commands. Reference this when designing or changing this repo's CLI surface."
cli_version: "0.1.1"
schema_version: 1
---

<!-- Installed by `project-canon skill install` — ai-first-cli-canon cli_version=0.1.1 schema_version=1. Generated from AGENTS-AI-FIRST-CLI.md; do not hand-edit, re-run to upgrade. -->
